    ...
    <div class="hero fullscreen">
        <div class="hero-body">
            <div style="margin: auto">
                ...
                <!-- FORM START -->
                <form class="frame p-0" action="list-offer" method="POST">
                    @csrf
                            ...
                            <div class="col">
                                ...
                                <div class="padded">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="mail" class="form-group-input" placeholder="Enter your email"
                                            name="email" />
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-group-input" placeholder="City" name="city" />
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-group-input" placeholder="Offer Price"
                                            name="price" />
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="select form-group-input" name="product">

                                            <option name="product">{{ $product->product_name }}</option>
